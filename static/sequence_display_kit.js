document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupPaintingListForModal() {
        ...
        // Setup barcode scanner per il modal
        setupBarcodeScannerForModal();
    }

    function setupBarcodeScannerForModal() {
        const barcodeScanBtn = document.getElementById('modalEditBarcodeScanBtn');
        
        if (barcodeScanBtn) {
            barcodeScanBtn.addEventListener('click', function() {
                // Callback che verrà chiamato quando viene rilevato un codice
                const onBarcodeDetected = function(code) {
                    console.log('Codice rilevato dal scanner:', code);
                    
                    // Aggiungi il codice alla painting list
                    const hiddenInput = document.getElementById('modalEditPaintingList');
                    const tableBody = document.getElementById('modalEditScannedCodesBody');
                    const countElement = document.getElementById('modalEditPaintingListCount');
    ...
    // Aggiungi gli stili CSS per le animazioni dei messaggi
